  ...
  return (
    <section className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Link to="/customer/payment-history" className="app-card hover:shadow-lg transition">
          <p className="app-kicker">💳</p>
          <h4 className="mt-2 font-semibold text-slate-950 dark:text-white">Payment History</h4>
          <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">View your invoices & payments</p>
        </Link>
